...
class WidgetSNNewIncidentsToday extends React.Component {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    constructor(props) {
        ...
        this.state = { widgetName: "WidgetSNNewIncidentsToday", count: [], instance: props.instance };
    ...
    render() {
        return (
            <DashboardDataCard
                ...
                widgetName="WidgetSNNewIncidentsToday"
            >
                {this.renderCardBody()}
            </DashboardDataCard>
        );
